...
viewPassword?
  ...
  <FaEyeSlash onClick={()=>setViewPassword(!viewPassword)} className='text-gray-400  cursor-pointer '  style={{marginLeft:"-30px",marginTop:"-3px"}}/>
  :
<FaEye onClick={()=>setViewPassword(!viewPassword)} className='text-gray-400  cursor-pointer '  style={{marginLeft:"-30px",marginTop:"-3px"}}/>
}
